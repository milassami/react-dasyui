    ...
    <div class="overflow-hidden bg-white">
      <div class="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div class="max-w-2xl w-3/4 lg:w-1/2 mb-6 sm:mb-10 md:mb-16">
          <h2 class="text-2xl sm:text-3xl lg:text-4xl text-gray-800 dark:text-gray-900 font-semibold">
            Loved by business and individuals across the globe
          </h2>
        </div>
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div class="flex h-auto">
            <div class="flex flex-col bg-white rounded-xl dark:bg-slate-100">
              ...
              <div class="p-4 bg-gray-100 rounded-b-xl md:px-7 dark:bg-slate-300">
                <div class="flex items-center">
                  ...
                  <div class="grow ml-3">
                    <p class="text-sm sm:text-base font-semibold text-gray-900 dark:text-gray-900">
                      Josh Tyson
                    </p>
                    <p class="text-xs text-gray-500 dark:text-gray-900">
          ...
          <div class="flex h-auto">
            <div class="flex flex-col bg-white rounded-xl bg-blue-400">
              <div class="flex-auto p-4 md:p-6">
                <p class="text-base italic md:text-lg text-white">
          ...
          <div class="flex h-auto">
            <div class="flex flex-col bg-white rounded-xl bg-orange-500">
              <div class="flex-auto p-4 md:p-6">
